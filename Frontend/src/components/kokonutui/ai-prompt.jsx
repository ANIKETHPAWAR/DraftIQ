...
export default function AI_Prompt() {
  ...
  return (
    <div className="w-4/6 py-4">
      <div className="rounded-2xl bg-white/50 p-1.5 pt-4 dark:bg-white/5">
        ...
        <div className="relative">
          <div className="relative flex flex-col">
            ...
            <div
              className="flex h-14 items-center rounded-b-xl bg-black/5 dark:bg-white/5">
              <div
                className="absolute right-3 bottom-3 left-3 flex w-[calc(100%-24px)] items-center justify-between">
